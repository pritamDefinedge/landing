(window.Modernizr = (function (e, t, n) {
  ...
  var f,
    ...
    z = {}.hasOwnProperty;
  (d =
    a(z, "undefined") || a(z.call, "undefined")
      ? function (e, t) {
    ...
    (N.smil = function () {
      return (
        !!t.createElementNS &&
        /SVGAnimate/.test(w.call(t.createElementNS(j.svg, "animate")))
      );
    }),
    (N.svgclippaths = function () {
      return (
        !!t.createElementNS &&
        /SVGClipPath/.test(w.call(t.createElementNS(j.svg, "clipPath")))
      );
    });
  for (var F in N)
    d(N, F) &&
  ...
  (function (e, t, n) {
    ...
    function s(e, n, r, o, a, s, l) {
      ...
      1 === T[n] && ((g = 1), (T[n] = [])),
        ...
        "img" != e &&
          (g || 2 === T[n]
            ? (x.insertBefore(f, E ? null : h), m(u, l))
            : T[n].push(f));
    }
